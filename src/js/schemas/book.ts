...
export const BookSchema = z.object({
  ...
  seriesId: z.string().max(100, 'Series ID must be 100 characters or less').nullable().optional(),

  seriesPosition: z.union([z.number().positive('Series position must be a positive number'), z.null()]).optional(),
  ...
  deletedAt: z.union([z.number().positive(), z.null()]).optional().default(null),
});
